...
morpheus::csh_desc_stats::csh_desc_stats(morpheus * parent, const int timer_opaque, const rofl::cofctl * const src, const rofl::cofmsg_desc_stats_request * const msg):chandlersession_base(parent, timer_opaque) {
